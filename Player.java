...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		double playerTop = this.cy - (this.height/2);
		if (playerTop > this.v_limit[0])
			this.cy -= ((double)delta * this.speed);
	...
	*/
	...
	public void moveDown(long delta){
		double playerBottom = this.cy + (this.height/2);
		if(playerBottom < this.v_limit[1])
